...
**OPTIONS:**
**A) Both loops behave identically**
...
**since stop_reason and trailing text emptiness**
...
**because a populated final text block**

내용이 채워진 마지막 텍스트 블록이

**is treated as the only reliable indicator**
...
**now covers all three concerns at once**
...
**on a different ephemeral build machine.**
...
**cross-machine resumption entirely**
...
**to derive the normalized amount**
...
**as updatedInput automatically propagates**
